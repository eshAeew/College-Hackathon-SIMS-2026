...
- [x] Retrieve last N test runs for a project.
- [x] Count consecutive and total failures per test case.
- [x] Compute failure recurrence rate (e.g. failed 4 out of last 5 runs).
