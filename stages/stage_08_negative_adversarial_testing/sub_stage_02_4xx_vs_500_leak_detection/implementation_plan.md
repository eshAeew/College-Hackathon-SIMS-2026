...
- [ ] Identify tests marked as `is_negative_test`.
- [ ] Assert that server returns 4xx (400, 422, 401, 403, 404).
- [ ] Tag any 500/502/503 response as 'CRITICAL: Unhandled Server Exception / Missing Validation'.
