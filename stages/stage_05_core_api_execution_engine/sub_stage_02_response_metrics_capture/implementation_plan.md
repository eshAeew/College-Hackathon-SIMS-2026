...
- [x] Measure total elapsed latency in milliseconds with sub-millisecond precision.
- [x] Capture HTTP status code, response headers, and response body (text/binary).
- [x] Intercept network errors: ConnectionRefused, DNSLookupError, TimeoutException, SSLValidationError.
