...
- [ ] Extract latency arrays from execution results.
- [ ] Compute min, max, average, median, p95, p99 latency in ms.
- [ ] Store aggregated performance metrics in TestRun records.
