...
- [x] Compare actual latency with endpoint `max_latency_ms` setting.
- [x] Tag results: FAST (<200ms), ACCEPTABLE (200-500ms), SLOW (500-1000ms), CRITICAL (>1000ms).
- [x] Trigger performance warning flags in test run summaries.
