...
- [x] Execute `jsonschema.validate()` against actual response JSON.
- [x] Extract detailed field-level mismatch errors (missing field, type mismatch: expected int, got str).
- [x] Generate human-readable validation summary diff.
