...
- [ ] PASS: All status, format, and schema assertions succeeded.
- [ ] FAIL: Functional assertion failure (status mismatch, schema violation).
- [ ] WARNING: Functional pass but performance SLA breached or minor anomaly.
- [ ] ERROR: Network timeout, DNS failure, connection refused, or invalid URL.
