...
- [x] Calculate pass/fail ratio across iterations.
- [x] Detect status code switching (e.g., 200 -> 200 -> 503 -> 200).
- [x] Flag endpoint as 'INCONSISTENT / FLAKY' if status variation > 0%.
