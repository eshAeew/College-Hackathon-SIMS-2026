...
- [ ] Identify previous baseline run for comparison.
- [ ] Compare status codes (e.g., previously 200, now 500).
- [ ] Compare latency changes (flag >50% latency degradation as regression).
