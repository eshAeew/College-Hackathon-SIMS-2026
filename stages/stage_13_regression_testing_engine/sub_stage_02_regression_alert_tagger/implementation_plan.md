...
- [x] Tag functional regressions (passing tests that now fail).
- [x] Tag performance regressions (significant latency increases).
- [x] Generate a dedicated 'Regressions Detected' section in the run summary.
